...
$results = $db->query("SELECT p.prayer_id, prayer_title_tx, prayer_desc_tx, prayer_subject_person_nm, archive_fl, f.prayer_priority_cd
FROM prayer p LEFT JOIN prayer_frequency f ON p.prayer_id = f.prayer_id");
