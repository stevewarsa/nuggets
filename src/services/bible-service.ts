...
export class BibleService {
    ...
    async addMemoryPassage(
        ...
        try {
            const response = await axios.get(
                `${BibleService.BASE_URL}add_memory_passage.php`,
                {
                    params: {
                        user,
                        translation,
    ...
    async updateReadingPlan(
        ...
        try {
            const response = await axios.get(
                `${BibleService.BASE_URL}update_reading_plan.php`,
                {
                    params: {
                        user,
                        dayOfWeek,
    ...
    async getQuoteList(
        user: string,
        includeQuoteText: boolean = false
    ): Promise<Quote[]> {
        try {
            const response = await axios.get(
    ...
    async addNonMemoryPassage(
        ...
        try {
            const response = await axios.get(
                `${BibleService.BASE_URL}add_nonmemory_passage.php`,
                {
                    params: {
                        user,
                        translation,
    ...
    async addPrayer(prayer: Prayer): Promise<string> {
        try {
            const response = await axios.post(
                `${BibleService.BASE_URL}add_prayer.php`,
                prayer
            );
            return response.data;
        } catch (error) {
    ...
    async updatePrayer(editingPrayer: Prayer, userId: string): Promise<string> {
        try {
            const response = await axios.post(
                `${BibleService.BASE_URL}update_prayer.php`,
                {
    ...
    async archivePrayer(userId: string, prayerId: number): Promise<string> {
        try {
            const response = await axios.get(
...
// Export a singleton instance of the BibleService class
